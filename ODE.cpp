...
void InitRobot()
{
    ...
    //질량중심점
    dReal x[MAX_JOINT_NUM + 1] = { 0.00, 0.5, 1.25 };
    dReal y[MAX_JOINT_NUM + 1] = { 0.0, 0.0, 0.0 };
    dReal z[MAX_JOINT_NUM + 1] = { 0.25, 0.5, 0.5 };

    //링크 자세
    dReal ori_x[MAX_JOINT_NUM + 1] = { 0.0, 0.0, 0.0 };
    dReal ori_y[MAX_JOINT_NUM + 1] = { 0.0, 1 , 1.0 };
    dReal ori_z[MAX_JOINT_NUM + 1] = { 1 , 0.0, 0.0 };
    dReal ori_q[MAX_JOINT_NUM + 1] = { 0.0, M_PI/2, M_PI/2 };
    //림 한덩이 링크 길이
